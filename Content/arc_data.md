...
- **ATOS (Active Targeting & Optimization Suite):** We developed a custom Python rocket flight simulator based off OpenRocket with software-in-the-loop (SITL) capabilities and married it to a binary search engine. The binary search engine iteratively finds the optimal PID constants for our flight controller. Rocket data can be imported via an OpenRocket simulation file. The original Python notebooks can be found at our [active airbrake control repository](https://github.com/ethsrocketry/airbrake-active-control), and the much more user-friendly ATOS website tool can be found [here](https://ethsrocketry.github.io/airbrake-active-control/). A guide to general ARC-style active airbrakes development was also created, and can be found [here](https://docs.google.com/document/d/1i_UKwctMrYWo29xRQ_8gYM4So_7c6D-xA6ojEPu1kk4/edit?tab=t.0).
