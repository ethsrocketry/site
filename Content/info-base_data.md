...
## Syntax
link(Site Syntax, Documentation on the functions of each and every site page, DOC, https://github.com/ethsrocketry/site/blob/main/readme.md)
...
## Resources
link(ATOS, Altitude Targeting & Optimization Suite, LINK, https://ethsrocketry.github.io/airbrake-active-control/)
link(Guide to Active Control Development in the Context of Airbrakes, Document, LINK, https://docs.google.com/document/d/1i_UKwctMrYWo29xRQ_8gYM4So_7c6D-xA6ojEPu1kk4/edit?tab=t.0)
